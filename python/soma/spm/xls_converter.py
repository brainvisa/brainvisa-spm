...
class XlsConverter():
  ...
  """
  def __init__(self, separator=';', interpret_boolean_values=False, header_sort_depth=1):
    self.separator = ';'
    self.interpret_boolean_values = interpret_boolean_values
    self.header_sort_depth = header_sort_depth
  ...
  def run(self, xls_path):
    ...
    if not self.sheet_dict_deque:
      ...
      for sheet_dict in self.sheet_dict_deque:
        ...
        column_values_dict = self._sortHeaderByDepth(column_values_dict,
                                                     self.header_sort_depth)
  ...
  def _sortHeaderByDepth(self, column_values_dict, sort_depth=0):
    if isinstance(column_values_dict, dict) and sort_depth > 0:
      column_values_ordered = OrderedDict()
      for k, v in sorted(column_values_dict.items()):
        column_values_ordered[k] = self._sortHeaderByDepth(v, sort_depth-1)
      return column_values_ordered
    else:
...
#==============================================================================
  ...
  def _index_column_to_letters(self, column_index):
    column_number = column_index +1
    r = ''
    first = column_number//26
    sec = column_number%26
    if sec == 0:
      first -= 1
      sec = 26
